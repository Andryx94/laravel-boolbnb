@php
  use Carbon\Carbon;
  $now = Carbon::now();
  $now_18 = $now->subYears(18)->toDateString();
@endphp
                  ...
                  <div class="card-body">
                      <form method="POST" action="{{ route('register') }}">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input id="birth_date" type="date" value="" min="1900-01-01" max="{{$now_18}}" class="form-control @error('birth_date') is-invalid @enderror" name="birth_date" value="{{ old('birth_date') }}" required autocomplete="birth_date" autofocus>
